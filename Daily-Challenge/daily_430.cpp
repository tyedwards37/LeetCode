/* Daily Question: 2658. Maximum Number of Fish in a Grid
 * by Tyler Edwards | Janaury 27th, 2025 
 * Code Credit: Kishan Kumar Patel
 * You are given a 0-indexed 2D matrix grid of size m x n, where (r, c) represents:rses - 1. 
